...
UserInfo::UserInfo(QString username, QString password, QString lowerInterface, QString upperInterface, QObject *parent) :
    InterfaceInfo(lowerInterface, upperInterface)
{
